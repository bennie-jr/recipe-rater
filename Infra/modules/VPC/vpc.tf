...
# Route the private subnet traffic through the NAT
...
# Route table main2 and private subnet associations
resource "aws_route_table_association" "private" {
  count = var.availability_zones_count

  subnet_id      = aws_subnet.private[count.index].id
  route_table_id = aws_route_table.main2[count.index].id
}
